...
- [WindowsBot手册](#windowsbot手册)
	- [创建/关闭WindowsBot](#创建关闭windowsbot)
		- [主函数示例](#主函数示例)
		- [关闭WindowsBot](#关闭windowsbot)
	- [等待超时](#等待超时)
	- [操作模式](#操作模式)
	- [查找窗口句柄](#查找窗口句柄)
	- [鼠标操作](#鼠标操作)
	...
	- [窗口元素操作](#窗口元素操作)
		- [查找元素](#查找元素)
		- [元素方法](#元素方法)
	- [内置浏览器(WebBot)](#内置浏览器webbot)
		- [WebBot操作](#webbot操作)
		- [获取元素](#获取元素)
		- [元素方法](#元素方法-1)
		- [注入JavaScript](#注入javascript)
		- [node与V8数据共享](#node与v8数据共享)
		- [Cookie操作](#cookie操作)
	- [Word文档](#word文档)
	- [Excel文档](#excel文档)
	- [邮件收发](#邮件收发)
